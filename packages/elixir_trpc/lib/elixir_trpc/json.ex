defmodule ElixirTRPC.JSON do
  @moduledoc """
  JSON encoding and decoding abstraction for ElixirTRPC.

  This module provides a thin abstraction layer over JSON libraries, allowing
  `ElixirTRPC` to work with different JSON implementations without hard
  dependencies.
  ...
  1. Application config: `config :elixir_trpc, :json_library, Jason`
  ...
  ## Examples
      ...
      # Encoding
      ElixirTRPC.JSON.encode!(%{user: "john"})
      # => ~s|{"user":"john"}|

      # Decoding
      ElixirTRPC.JSON.decode!(~s|{"user":"john"}|)
      # => %{"user" => "john"}
  ...
  ## Examples
      ...
      iex> ElixirTRPC.JSON.encode!(%{name: "John"})
      ~s|{"name":"John"}|
  ...
  ## Examples
      ...
      iex> ElixirTRPC.JSON.encode(self())
  ...
  ## Examples
      ...
      iex> ElixirTRPC.JSON.decode!(~s|{"name":"John"}|)
      %{"name" => "John"}
  ...
  ## Examples
      ...
      iex> ElixirTRPC.JSON.decode("invalid json")
