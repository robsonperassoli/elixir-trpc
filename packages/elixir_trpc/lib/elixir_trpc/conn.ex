defmodule ElixirTRPC.Conn do
  ...
  and returning JSON responses in ElixirTRPC endpoints.

  ## Usage

  Typically, you won't need to use this module directly as `ElixirTRPC.Function`
  ...
  ## Examples
      ...
      defmodule MyCustomMiddleware do
        ...
        def call(conn, opts) do
          ...
          ElixirTRPC.Conn.json_response(conn, %{success: true})
        end
      end
